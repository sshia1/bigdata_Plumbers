#
# COVID-19 RapidAPI/Kafka producer interface.  Dewrangles RapidAPI data and sends one record at a time to 
# Kafka consumer
#
...
headers		= {
				...
				'x-rapidapi-key': "" # key is deleted for purpose of security
}
